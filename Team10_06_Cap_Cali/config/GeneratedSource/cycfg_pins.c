...
#if defined (CY_USING_HAL) || (CY_USING_HAL_LITE)
const cyhal_resource_inst_t ioss_0_port_7_pin_7_obj =
{
    .type = CYHAL_RSC_GPIO,
    .block_num = ioss_0_port_7_pin_7_PORT_NUM,
    .channel_num = ioss_0_port_7_pin_7_PIN,
};
#endif /* defined (CY_USING_HAL) || (CY_USING_HAL_LITE) */
...
void reserve_cycfg_pins(void)
{
    ...
    cyhal_hwmgr_reserve(&ioss_0_port_7_pin_7_obj);
